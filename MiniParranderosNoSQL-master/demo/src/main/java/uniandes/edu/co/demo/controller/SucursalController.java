            ...
            for (Bodega bodega : bodegas) {
                for (RecepcionProducto recepcionProducto : bodega.getRecepcionProducto()) {
                    String reporte = String.format(
                        "Bodega: %s, Producto: %s, Cantidad Actual: %d, Cantidad Mínima: %d, Costo Unitario: %d",
                        bodega.getNombre(),
                        recepcionProducto.getId(),  // Asumo que el ID representa al producto
                        recepcionProducto.getCantidadRecibida(),
                        recepcionProducto.getCantidadMinima(),
                        recepcionProducto.getCostoUnitario()
                    );
